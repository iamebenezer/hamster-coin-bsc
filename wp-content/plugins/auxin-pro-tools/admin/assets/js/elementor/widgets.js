...
(function($, window, document, undefined) {
    ...
    $(window).on('elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/aux_counter.default', function($scope) {
            $.fn.AuxinCounter($scope);
        });
        elementorFrontend.hooks.addAction('frontend/element_ready/aux_faq.default', function($scope) {
